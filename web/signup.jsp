...
<div class="container container-small">
    <h1>注册
        <small>已有帐号，<a href="login.html">登录</a></small>
    </h1>
    <form id="signupForm" action="signup" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nickname" placeholder="请输入名称">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="mobile" placeholder="请输入手机号码">
        </div>
        <div class="form-group">
            <label>电子邮件</label>
        ...
        <div class="form-group">
            <label>出生日期</label>
            <input type="text" class="form-control" name="birthday" id="datetimepicker" placeholder="请选择您的出生日期">
        </div>
        <div class="form-group">
            <label>头像</label>
            <div>
